          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 relative z-10">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch">
              ...
              <div className="lg:col-span-4 flex flex-col gap-4 justify-between">
                {[
                  { icon: "🏏", label: "Active Squad", value: `${stats.totalMembers}+`, sub: "registered players", borderColor: "border-jcc-accent/20", glowColor: "from-jcc-accent/10", textColor: "text-jcc-accent" },
                  { icon: "⚡", label: "Matches Played", value: `${stats.matchesPlayed}+`, sub: "since season start", borderColor: "border-yellow-400/20", glowColor: "from-yellow-400/10", textColor: "text-yellow-400" },
                  { icon: "🔥", label: "Sundays Strong", value: `${stats.matchesPlayed}+`, sub: "consecutive Sundays", borderColor: "border-orange-500/20", glowColor: "from-orange-500/10", textColor: "text-orange-400" },
                ].map((item, i) => (
                  <div key={i} className={`group relative overflow-hidden rounded-2xl border ${item.borderColor} bg-gradient-to-br ${item.glowColor} to-transparent p-5 flex items-center gap-4 cursor-default hover:scale-[1.02] transition-all duration-300`}>
          ...
          >
              ...
              <div className="group relative rounded-2xl border border-white/10 bg-gradient-to-b from-white/[0.06] to-white/[0.02] overflow-hidden hover:border-jcc-accent/30 transition-all duration-500">
                ...
                <div className="p-4 sm:p-8">
                  ...
                  <div className="flex items-center gap-1.5 sm:gap-3 mb-3.5 sm:mb-6 md:mb-8">
                    <TeamBadge name="Mavericks" color="border-jcc-accent/20" accent="bg-jcc-accent/20" />
                  ...
                  <div className="mb-3.5 sm:mb-6 md:mb-8">
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <div className="flex items-center gap-2">
                        {isClosed ? (
                          <span className="px-2 py-0.5 rounded-full bg-jcc-ball-red/15 border border-jcc-ball-red/25 text-jcc-ball-red text-[9px] font-black uppercase tracking-widest">Closed</span>
                        ) : isFull ? (
                          <span className="px-2 py-0.5 rounded-full bg-jcc-gold/15 border border-jcc-gold/25 text-jcc-gold text-[9px] font-black uppercase tracking-widest">Full</span>
                        ) : (
                          <span className="px-2 py-0.5 rounded-full bg-emerald-400/15 border border-emerald-400/25 text-emerald-400 text-[9px] font-black uppercase tracking-widest animate-pulse">Open</span>
                        )}
                  ...
                  {/* CTA */}
                  {isClosed ? (
                    <button disabled className="inline-flex items-center gap-2.5 bg-white/5 border border-white/10 text-white/30 text-[12px] sm:text-[13px] font-black w-full sm:w-auto justify-center px-5 py-3 sm:px-6 sm:py-4 rounded-xl cursor-not-allowed uppercase tracking-wider">
            ...
            <motion.div variants={fadeUp} className="lg:col-span-4 flex flex-col gap-4">
              {[
                { icon: "🏏", label: "Active Squad", value: `${stats.totalMembers}+`, sub: "registered players", borderColor: "border-jcc-accent/20", glowColor: "from-jcc-accent/10", textColor: "text-jcc-accent" },
                { icon: "⚡", label: "Matches Played", value: `${stats.matchesPlayed}+`, sub: "since season start", borderColor: "border-yellow-400/20", glowColor: "from-yellow-400/10", textColor: "text-yellow-400" },
                { icon: "🔥", label: "Win Streak", value: "3", sub: "matches in a row", borderColor: "border-orange-500/20", glowColor: "from-orange-500/10", textColor: "text-orange-400" },
                { icon: "👑", label: "Sundays Strong", value: `${stats.matchesPlayed}+`, sub: "consecutive Sundays", borderColor: "border-jcc-green/20", glowColor: "from-jcc-green/10", textColor: "text-jcc-green" },
              ].map((item, i) => (
                <motion.div
                  key={i}
