  ...
  return (
    <>
      ...
      <section id="why-jcc" className="py-24 sm:py-32 relative section-bg-navy overflow-hidden">
        <div className="absolute inset-0 bg-linear-to-r from-jcc-navy/40 to-transparent" />
            ...
            {features.map((feature, i) => (
              <AnimateIn key={i} delay={i * 100}>
                <div className="premium-card p-8 group h-full">
                  ...
                  <p className="text-jcc-text-soft text-sm font-medium leading-relaxed">{feature.description}</p>
                </div>
              </AnimateIn>
            ))}
          </div>
