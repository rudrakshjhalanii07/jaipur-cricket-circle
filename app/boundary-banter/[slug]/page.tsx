...
export default function BlogPostPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  if (loading) {
    return (
      <div className="min-h-screen page-top flex items-center justify-center bg-jcc-bg">
  ...
  return (
    <div className="min-h-screen page-top pb-20 bg-jcc-bg relative overflow-hidden">
