...
export default function TournamentPageClient({ initialTournament, initialMatches }: TournamentPageClientProps) {
  const [view, setView] = useState<PageView>(initialTournament ? "schedule" : "landing");
